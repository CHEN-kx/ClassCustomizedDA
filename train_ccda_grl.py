...
from network import resnet50, resnet101, AdversarialNetwork, DisAdversarialNetwork
...
def train(config):
    ...
    adversarial_net_fatt1 = AdversarialNetwork(base_network.out_features, 1024)
    adversarial_net_fatt1 = adversarial_net_fatt1.cuda().train(True) 
    adversarial_net_fatt2 = AdversarialNetwork(base_network.out_features, 1024)
    adversarial_net_fatt2 = adversarial_net_fatt2.cuda().train(True) 
    adversarial_net_frep = DisAdversarialNetwork(base_network.out_features, 1024)
    adversarial_net_frep = adversarial_net_frep.cuda().train(True) 
    ...
    parameter_list = [
        ...
        {"params": adversarial_net_fatt1.parameters(), "lr_mult":10, 'decay_mult':2},
        {"params": adversarial_net_fatt2.parameters(), "lr_mult":10, 'decay_mult':2},
        {"params": adversarial_net_frep.parameters(), "lr_mult":10, 'decay_mult':2}
    ]
